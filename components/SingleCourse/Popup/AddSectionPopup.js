...
const AddCourseSectionPopup = ({ openPopup, setPopup, selected, loadCourseDetails }) => {
  ...
  const handleCreateSection = async () => {
    try {
      ...
      const res = await axios.post(`${process.env.API}/api/course-section/create`, {
        ...obj,
...
export default AddCourseSectionPopup;
