    ...
    return (
        <div className='pl-14 w-[30%]'>
            ...
            <div className='mt-9'>
                ...
                <input className={styles.input} placeholder='Event host' />
                <input className={styles.input} placeholder='Price' />
            </div>

            <div>
                <textarea rows="8" className={styles.input} placeholder="Policy"></textarea>
            </div>
            ...
            <div className='flex justify-end mt-5 gap-4'>
                ...
                <div>
                    <button className={`${styles.button} bg-indigo`}> Publish </button>
                </div>
            </div> */}
        </div>
    );
